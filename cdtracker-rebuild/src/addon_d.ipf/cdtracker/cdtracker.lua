...
function CDTRACKER_ON_INIT(addon, frame)
    ...
    CDTRACKER_SAVESETTINGS()
	acutil.addSysIcon("cdtracker", "addonmenu_cdtracker", "Cooldown Tracker", "CDTRACKER_TOGGLE_FRAME");
...
function CD_DRAG_STOP(frame, ctrl, cdtype, slot)
    CD_DRAG_STATE = false
    ...
    if iconPt  ~=  nil then
        ...
        if iconInfo:GetCategory() == 'Skill' then
            ...
            if settings.chatList['[Skill] '..cdTrackSkill[index]['fullName']] == true and cdTrackSkill[index]['curTimeSecs'] == 0 and checkChatFrame:IsVisible() == 0 then
                if cdLastSkillCast == cdTrackSkill[index]['fullName'] and not TIME_ELAPSED(0) then
                else
...
function DISPLAY_SLOT(index, slot, name, cooldown, cdtype, obj, duration, buffArg)
    ...
    if settings.lock then
        ...
        cdFrame:SetEventScriptArgString(ui.LBUTTONUP, tostring(cdtype));
        cdFrame:SetEventScriptArgNumber(ui.LBUTTONUP, tonumber(slot));
    end
    -- if cdtype == 'BUFF' then
...
function CD_CALL_UI(frame, ctrl, argStr)
    ui.Chat('/cd '..argStr);
end

function CD_ON_SKIN(frame, ctrl)
    local k = cdTrackerUIObjects['skindroplist']:GetSelItemIndex();

    ui.Chat('/cd skin '..tostring(k));
end

function CD_ON_SOUND(frame, ctrl)
    local k = cdTrackerUIObjects['soundtypedroplist']:GetSelItemIndex();
    ui.Chat('/cd sound '..tostring(k));
end
...
function CD_HIDE_CONTROL(frame, ctrl, argStr)
    cdTrackerUIObjects[argStr]:ShowWindow(0);
end
...
function CDTRACKER_CREATE_FRAME()
    ...
    cdTrackerUIObjects['enabled']:SetEventScript(ui.LBUTTONUP, "TOGGLE_CD");
    cdTrackerUIObjects['enabled']:SetEventScriptArgString(ui.LBUTTONUP, 'enabled');
    ...
    cdTrackerUIObjects['skills']:SetEventScript(ui.LBUTTONUP, "TOGGLE_CD");
    cdTrackerUIObjects['skills']:SetEventScriptArgString(ui.LBUTTONUP, 'skills');
    ...
    cdTrackerUIObjects['buffs']:SetEventScript(ui.LBUTTONUP, "TOGGLE_CD");
    cdTrackerUIObjects['buffs']:SetEventScriptArgString(ui.LBUTTONUP, 'buffs');
    ...
    cdTrackerUIObjects['text']:SetEventScript(ui.LBUTTONUP, "TOGGLE_CD");
    cdTrackerUIObjects['text']:SetEventScriptArgString(ui.LBUTTONUP, 'text');
    ...
    cdTrackerUIObjects['sound']:SetEventScript(ui.LBUTTONUP, "TOGGLE_CD");
    cdTrackerUIObjects['sound']:SetEventScriptArgString(ui.LBUTTONUP, 'sound');
    ...
    cdTrackerUIObjects['lock']:SetEventScript(ui.LBUTTONUP, "TOGGLE_CD");
    cdTrackerUIObjects['lock']:SetEventScriptArgString(ui.LBUTTONUP, 'lock');
    ...
    cdTrackerUIObjects['showframes']:SetEventScript(ui.LBUTTONUP, "CD_CALL_UI");
    cdTrackerUIObjects['showframes']:SetEventScriptArgString(ui.LBUTTONUP, 'showframes');
    ...
    cdTrackerUIObjects['timebox']:SetEventScript(ui.LBUTTONUP,"CD_HIDE_CONTROL")
    cdTrackerUIObjects['timebox']:SetEventScriptArgString(ui.LBUTTONUP, 'timelabel');
    ...
    cdTrackerUIObjects['sizebox']:SetEventScript(ui.LBUTTONUP,"CD_HIDE_CONTROL")
    cdTrackerUIObjects['sizebox']:SetEventScriptArgString(ui.LBUTTONUP, 'sizelabel');
    ...
    for k,v in pairs(frameSkins) do 
        cdTrackerUIObjects['skindroplist']:AddItem(k,v,0,"CD_ON_SKIN")
    end
    ...
    for k,v in pairs(soundTypes) do 
        cdTrackerUIObjects['soundtypedroplist']:AddItem(k,v,0,"CD_ON_SOUND")
    end
    ...
    cdTrackerUIObjects['helpbox']:SetEventScript(ui.LBUTTONUP, "CD_CALL_UI");
    cdTrackerUIObjects['helpbox']:SetEventScriptArgString(ui.LBUTTONUP, 'help all');
...
function CD_LIST()
    local t,p = pcall(CD_LIST_S);
    if not(t) then
        print("CDTRACKER ERROR: "..tostring(p));
    end
end
...
function CD_LIST_S()
    ...
    for k, v in ipairs(skillList) do
        ...
        cdTrackerUIObjects['skillalert'..k]:SetEventScript(ui.LBUTTONUP,"CD_SET_SKILL_ALERT")
        cdTrackerUIObjects['skillalert'..k]:SetEventScriptArgString(ui.LBUTTONUP,k)
        ...
        cdTrackerUIObjects['skillchat'..k]:SetEventScript(ui.LBUTTONUP,"CD_SET_SKILL_CHAT")
        cdTrackerUIObjects['skillchat'..k]:SetEventScriptArgString(ui.LBUTTONUP,k)
        ...
        cdTrackerUIObjects['skillmessage'..k]:SetEventScript(ui.LBUTTONUP,"CD_SET_CHAT_MESSAGE")
        cdTrackerUIObjects['skillmessage'..k]:SetEventScriptArgString(ui.LBUTTONUP,k)
        ...
        cdTrackerUIObjects['skilltime'..k]:SetEventScript(ui.LBUTTONUP,"CD_HIDE_CONTROL")
    ...
    for k,v in ipairs(buffList) do 
        ...
        cdTrackerUIObjects['buffalert'..k]:SetEventScript(ui.LBUTTONUP,"CD_SET_BUFF_ALERT")
        cdTrackerUIObjects['buffalert'..k]:SetEventScriptArgString(ui.LBUTTONUP,k)
...
function CD_SET_BUFF_ALERT(frame, ctrl, id)
    ui.Chat('/cd alert '..tostring((tonumber(id)+#skillList)))
    CDTRACKER_LOADSETTINGS() 
   -- if settings.ignoreList[buffList[tonumber(id)]] == true then 
...
function TOGGLE_CD(frame, ctrl, setting)
    CDTRACKER_LOADSETTINGS()
...
function CD_SEND_CHAT_MESSAGE(frame, ctrl, id)
	...
	settings.message[skillList[id]] = message
	CDTRACKER_SAVESETTINGS()
	CDTRACKER_LOADSETTINGS()
...
function CD_SET_CHAT_MESSAGE(frame, ctrl, id)
    ...
    cdTrackerUIObjects['skillmessageinput'..id]:SetEventScript(ui.ENTERKEY,"CD_SEND_CHAT_MESSAGE")
    cdTrackerUIObjects['skillmessageinput'..id]:SetEventScriptArgString(ui.ENTERKEY, id);
end

function CD_SET_SKILL_CHAT(frame, ctrl, id)
    ui.Chat('/cd chat '..id) 
    CDTRACKER_LOADSETTINGS() 
...
function CD_SET_SKILL_ALERT(frame, ctrl, id)
    ui.Chat('/cd alert '..id) 
    CDTRACKER_LOADSETTINGS() 
